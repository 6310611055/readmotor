  ...
  */
  ...
  export type usersGetPayload<S extends boolean | null | undefined | usersArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        P extends 'posts' ? Array < postsGetPayload<S['include'][P]>>  :
        P extends '_count' ? UsersCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (usersArgs | usersFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'posts' ? Array < postsGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__usersClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    posts<T extends users$postsArgs= {}>(args?: Subset<T, users$postsArgs>): Prisma.PrismaPromise<Array<postsGetPayload<T>>| Null>;
  ...
  export type postsGetPayload<S extends boolean | null | undefined | postsArgs> =
    ...
    : S extends { select: any } & (postsArgs | postsFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? usersGetPayload<S['select'][P]> :  P extends keyof posts ? posts[P] : never
  } 
      : posts
